    ...
    <Layout isHomePage={true}>
      ...
      <section className="relative h-screen w-full flex items-center justify-center overflow-hidden bg-black dark:bg-black">
        ...
        >
          ...
          {/* Subtitle with Decrypted Text effect */}
          <motion.p
            variants={itemVariants}
            className="text-base tablet:text-lg laptop:text-xl desktop:text-2xl ultrawide:text-4xl 4k:text-5xl text-gray-300 leading-relaxed max-w-3xl ultrawide:max-w-5xl 4k:max-w-7xl mx-auto mb-8 4k:mb-12"
            style={{ fontFamily: "'Space Grotesk', sans-serif" }}
          >
            <DecryptedText
